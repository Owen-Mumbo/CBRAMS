...
<head>
    <title>Deputy Governor Registration Page</title>
    <style type="text/css">
        #container {
...
<body>
    <div id="container">
        ...
        <div id="header">
            <h1>Deputy Governor Registration</h1>
        </div>
        <form action="Deputy_Governor_Registration.php" method="POST" id="form" onsubmit="return validateForm()">
            <div id="form-group">
    ...
    $query = "INSERT INTO deputygovernor_table(ID_number, Username, Email, Phone, County_name, Password) VALUES ('$getID_number','$getusername','$getemail','$getphone','$getcounty_name','$getpassword')";
