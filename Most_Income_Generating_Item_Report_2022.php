...
$query = "select * from most_income_generating_item_2022";
...
<head>
    <title>Most Income Generating Item Report 2021/2022</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="3">Most Income Generating Item Report 2021/2022</th>
        </tr>
        <tr>
            <td>Revenue ID</td>
