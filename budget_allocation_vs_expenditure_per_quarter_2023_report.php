...
$sql = "Select * from budget_allocation_vs_expenditure_per_quarter_2023";
...
<head>
    <title>Budget Allocation vs Expenditure Per Quarter 2022/2023</title>
    <style>
        body {
...
<body>
    ...
    <table border="1" width="75%">
        <tr>
            <th colspan="9">Budget Allocation vs Expenditure Per Quarter 2022/2023</th>
        </tr>
        <tr>
            <td>Budget ID</td>
