...
//SQL query that selects all data from q4_revenue_collection table
$sql = "Select * from q4_2022_revenue_collection";
...
<head>
    <title>Q4 revenue collection 2021/2022</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="5">Q4 revenue collection 2021/2022</th>
        </tr>
        <tr>
