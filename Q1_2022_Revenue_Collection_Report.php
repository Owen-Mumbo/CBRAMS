...
//SQL query that selects all data from q1_revenue_collection table
$sql = "Select * from q1_2022_revenue_collection";
...
<head>
    <title>Q1 revenue collection 2021/2022</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="5">Q1 revenue collection 2021/2022</th>
        </tr>
        <tr>
