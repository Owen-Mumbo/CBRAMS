...
//SQL query that selects all data from q4_expenditure
$query = "select * from q4_2022_expenditure";
...
<head>
    <title>Q4 Expenditure Report</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="5">Quarter 4 Expenditure Report 2021/2022</th>
        </tr>
        <tr>
