...
<head>
    <title>CEC Member for Finance Registration Page</title>
    <style type="text/css">
        #container {
...
<body>
    <div id="container">
        ...
        <div id="header">
            <h1>CEC Member for Finance Registration</h1>
        </div>
        <form action="CEC_Member_for_Finance_Registration.php" method="POST" name="form" id="form"
    ...
    <script type="text/javascript">
        function validateForm() {
            ...
            if (email.length == 0 || email.indexOf("@") == -1 || emal.indexOf(".") == -1) {
    ...
    $query = "INSERT INTO CEC_table(ID_number,Username,Email,Phone,County_name,Password) VALUES ('$getID_number','$getusername','$getemail','$getphone','$getcounty_name','$getpassword')";
