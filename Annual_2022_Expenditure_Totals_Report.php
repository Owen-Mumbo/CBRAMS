...
//$query = "select * from quarterly_expenditure";
$query = "select * from annual_2022_expenditure_totals";
...
<head>
    <title>Annual Totals Expenditure Report 2021/2022</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="3">Annual Totals Expenditure Report 2021/2022</th>
        </tr>
        <tr>
            <td>Budget ID</td>
