...
<head>
    <title>Governor Registration Page</title>
    <style type="text/css">
        #container {
...
<body>
    <div id="container">
        ...
        <div id="header">
            <h1>Governor Registration</h1>
        </div>
        <form action="Governor_Registration.php" method="POST" id="form" onsubmit="return validateForm()">
            <div id="form-group">
    ...
    <?php
    //$_POST super-global array retrieve records sent to the server via the post method
    ...
    $query = "INSERT INTO governor_table(ID_number, Username, Email, Phone, County_name, Password) VALUES ('$getID_number','$getusername','$getemail','$getphone','$getcounty_name','$getpassword')";
