...
//SQL query that selects all data from q2_expenditure
$query = "select * from q2_2022_expenditure";
...
<head>
    <title>Q2 Expenditure Report</title>
    <style>
        body {
...
<body>
    <table border="1" width="75%">
        <tr>
            <th colspan="5">Quarter 2 Expenditure Report 2021/2022</th>
        </tr>
        <tr>
